...
<body>
    ...
    <div class="container2">
        <div class="formEdit">
            ...
            <form id="productEditForm" data-product-id="<?= $product->product_id ?>">
                <div class="form-container">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="provider_id" name="provider_id">
                            <?php foreach ($providers as $provider): ?>
                                <option value="<?= $provider->provider_id ?>" <?= $provider->provider_id == $product->provider_id ? 'selected' : '' ?>>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 col-sm-12 mb-3">
                            ...
                            <input type="number" min="0" step="0.01" class="form-control" id="price" name="price" value="<?= htmlspecialchars($product->price) ?>">
                        </div>
                    </div>
                    
                    <button type="submit" class="btn btn-primary">Actualizar Producto</button>
                    <a href="<?= base_url() ?>product/index" class="btn btn-secondary">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
